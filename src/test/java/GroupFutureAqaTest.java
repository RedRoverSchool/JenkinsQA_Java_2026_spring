...
public class GroupFutureAqaTest {
   ...
   //коммент чтобы в комите появился измененный файл
    ...
    @Test
    @Description("тест слайдера на учебном сайте")
    ...
    @Test
    @Description("тест окна для расшаривания на Яндекс Картах")
    ...
    @Test
    @Description("тест ошибка формы регистрации на учебном сайте")
    ...
    @Test
    @Description("тест появления маршрута после введения 2 точек из выпадающих списков на Яндекс картах")
    ...
    @Test
    @Description("тест цвет и текст сообщения об ошибке страница авторизации Jenkins")
    ...
    @Test
    @Description("тест цвет границ инпутов при ошибке страница авторизации Jenkins")
    ...
    @Test
    @Description("тест цвет кнопки Sing In страница авторизации Jenkins")
    ...
    @Test
    @Description("тест цвет чекбокса при наведении мыши страница авторизации Jenkins")
